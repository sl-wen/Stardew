...
# 生长阶段对应的纹理区域
var growth_stages = [
	Rect2(272, 144, 16, 16),  # 种子
	Rect2(288, 144, 16, 16),  # 发芽
	Rect2(304, 144, 16, 16),  # 生长
	Rect2(320, 144, 16, 16),  # 开花
	Rect2(272, 160, 16, 16),  # 结果（成熟）
	Rect2(272, 176, 16, 16),  # 枯萎
]
